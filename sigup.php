...
<form class="container-md col-7 bg-light border border-info rounded-3 " method="POST" action="">
...
<div class="mb-3 row">
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
      <input type="number" class="form-control" id="gst" placeholder="GST NO ex:-2523525542514" name="gst">
    </div>
  </div>
...
<br>
 ...
 <a href="seler_login.php"> <button type="reset" class="btn btn-outline-secondary btn-lg col-sm-4" name ="reset">Cancel</button></a>
</div><br>
  <div>
    <br>
</div>
...
$sql= "INSERT INTO `seler`(`mobile`, `fname`, `lname`, `mail`, `address`, `gst`, `city`, `state`, `zip`, `pass`)
 VALUES ('$mbile','$f_name','$l_name','$mail', '$address','$gst','$city','$state','$zip','$pass')";
